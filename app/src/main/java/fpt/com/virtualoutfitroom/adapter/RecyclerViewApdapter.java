...
public class RecyclerViewApdapter extends RecyclerView.Adapter<RecyclerViewApdapter.RecyclerViewHolder> {
    private Context mContext;
    private List<Product> mListProduct;
    private OnItemClickedListener mListener;

    public RecyclerViewApdapter(Context mContext , List<Product> mListProduct) {
    ...
    public class RecyclerViewHolder extends RecyclerView.ViewHolder {
        ...
        public RecyclerViewHolder(View itemView) {
            ...
            lnlRoot = itemView.findViewById(R.id.lnl_row_product);
        }
    }
